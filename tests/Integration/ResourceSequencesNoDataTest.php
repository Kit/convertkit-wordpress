...
/**
 * Tests for the ConvertKit_Resource_Sequences class when no data is present in the API.
 *
 * @since   3.1.3
 */
class ResourceSequencesNoDataTest extends WPTestCase
{
	/**
	...
	public function setUp(): void
	{
		...
		$this->resource = new \ConvertKit_Resource_Sequences();
