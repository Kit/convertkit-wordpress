...
class PageShortcodeFormCest
{
	...
	/**
	 * Test the [kit] shortcode works when a valid Form ID is specified.
	 *
	 * @since   3.4.4
	 *
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testFormShortcodeWithKitName(EndToEndTester $I)
	{
		// Setup Plugin.
		$I->setupKitPluginNoDefaultForms($I);
		$I->setupKitPluginResources($I);
		...
		$I->havePageInDatabase(
			[
				'post_name'    => 'kit-form-shortcode-kit-name',
				'post_content' => '[kit form="' . $_ENV['CONVERTKIT_API_FORM_ID'] . '"]',
			]
		);

		// Load the Page on the frontend site.
		$I->amOnPage('/kit-form-shortcode-kit-name');
