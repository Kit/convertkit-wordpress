...
class ForminatorCest
{
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorWhenNoCredentials(EndToEndTester $I)
	{
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorFormToKitTagMapping(EndToEndTester $I)
	{
		// Setup Forminator Form and configuration for this test.
		$pageID = $this->_forminatorSetupForm(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorFormToKitSequenceMapping(EndToEndTester $I)
	{
		// Setup Forminator Form and configuration for this test.
		$pageID = $this->_forminatorSetupForm(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorFormDoNotSubscribeOption(EndToEndTester $I)
	{
		// Setup Forminator Form and configuration for this test.
		$pageID = $this->_forminatorSetupForm(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorFormSubscribeOption(EndToEndTester $I)
	{
		// Setup Forminator Form and configuration for this test.
		$pageID = $this->_forminatorSetupForm(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorQuizToKitTagMapping(EndToEndTester $I)
	{
		// Setup Forminator Quiz and configuration for this test.
		$pageID = $this->_forminatorSetupQuiz(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorQuizToKitSequenceMapping(EndToEndTester $I)
	{
		// Setup Forminator Quiz and configuration for this test.
		$pageID = $this->_forminatorSetupQuiz(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorQuizDoNotSubscribeOption(EndToEndTester $I)
	{
		// Setup Forminator Quiz and configuration for this test.
		$pageID = $this->_forminatorSetupQuiz(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorQuizSubscribeOption(EndToEndTester $I)
	{
		// Setup Forminator Quiz and configuration for this test.
		$pageID = $this->_forminatorSetupQuiz(
			$I,
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorCreatorNetworkRecommendationsWhenDisabledOnKitAccount(EndToEndTester $I)
	{
		// Setup Kit Plugin.
...
[forminator_form id="' . $forminatorFormID . '"]',
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorCreatorNetworkRecommendationsWhenEnabledOnKitAccount(EndToEndTester $I)
	{
		// Setup Kit Plugin.
...
[forminator_form id="' . $forminatorFormID . '"]',
	 ...
	 * @param   EndToEndTester $I  Tester.
	 */
	public function testSettingsForminatorSpamProtectionWarningDoesNotDisplayWhenHoneypotEnabled(EndToEndTester $I)
	{
		// Setup Kit Plugin.
		$I->setupKitPluginNoDefaultForms($I);
		$I->setupKitPluginResources($I);

		// Create Forminator Form with honeypot protection enabled.
		$forminatorFormID = $this->_createForminatorFormWithHoneypot($I);
	 ...
	 * @return  int                     Form ID
	 */
	private function _createForminatorFormWithHoneypot(EndToEndTester $I)
	{
		return $I->havePostInDatabase(
			[
				'post_name'   => 'forminator-form-honeypot',
				'post_title'  => 'Forminator Form Honeypot',
	 ...
	 * @return  int                     Form ID
	 */
	private function _createForminatorForm(EndToEndTester $I)
	{
		return $I->havePostInDatabase(
			[
