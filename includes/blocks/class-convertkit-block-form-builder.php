...
/**
 * Kit Form Builder Block for Gutenberg and Shortcode.
 *
 * @package ConvertKit
 * @author  ConvertKit
 */
class ConvertKit_Block_Form_Builder extends ConvertKit_Block {
	...
	public function enqueue_scripts_editor() {
		...
		wp_enqueue_script( 'convertkit-gutenberg-block-form-builder', CONVERTKIT_PLUGIN_URL . 'resources/backend/js/gutenberg-block-form-builder.js', array( 'convertkit-gutenberg' ), CONVERTKIT_PLUGIN_VERSION, true );
	...
	public function get_overview() {
		...
		return array(
			...
			'description'                       => __( 'Build a subscription form that inherits your site\'s styles.', 'convertkit' ),
			...
			'gutenberg_preview_render_callback' => 'convertKitGutenbergFormBuilderBlockRenderPreview',
		);
